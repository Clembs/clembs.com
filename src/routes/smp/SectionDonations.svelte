...
<section id="section-0">
	...
	<p>
		Hosting a server isn't free, and while the first month is paid for by myself, I need your
		support to keep it alive for longer!
	</p>
	<p>When supporting, you will:</p>
	<ul>
