<script>
	import Img from '@zerodevx/svelte-img'; import banner from './banner.webp?as=run'; import emotes
	from './emotes.png?as=run'; import evolution from './evolution.png?as=run'; import icons from
	'./icons.png?as=run'; import idea from './idea.png?as=run'; import imNotHereScreen from
	'./im-not-here-screen.png?as=run'; import logoFullWidth from './logo-full-width.png?as=run';
	import streamBanners from './stream-banners.png?as=run'; import websiteDesktop from
	'./website-desktop.png?as=run'; import websiteMobile from './website-mobile.png?as=run';
</script>
...
<Img src="{banner}" alt="Clembs - Nice to meet you, again." />
...
<Img src="{evolution}" alt="History of Clembs logos" />
...
<Img src="{idea}" alt="Idea of the Clembs logo, showing a pencil + an eye + a C" />
...
<Img src="{logoFullWidth}" alt="Logo, Purplue gradient background" />
...
<Img src="{icons}" alt="Different types of themed and colorful icons" />
...
<Img src="{streamBanners}" alt={`A "I'M LIVE" screen showing `} />
...
<Img src="{websiteDesktop}" alt="Desktop screenshot of the website landing page" />
...
<div class="image-grid">
	<Img src="{websiteMobile}" alt="Mobile screenshot of CRBT software page" />
	<img
